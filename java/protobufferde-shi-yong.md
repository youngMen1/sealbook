...
1. 下载地址：[https://github.com/google/protobuf/releases。里面有windows版的:protoc-3.11.1.win32.zip。](https://github.com/google/protobuf/releases。里面有windows版的:protoc-3.6.1.win32.zip。)
2. 安装。
